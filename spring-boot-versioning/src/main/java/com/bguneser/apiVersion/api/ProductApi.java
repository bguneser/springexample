package com.bguneser.apiVersion.api;

import com.bguneser.apiVersion.dto.ProductV1;
import com.bguneser.apiVersion.dto.ProductV2;
...
public class ProductApi {
    ...
    public ResponseEntity<ProductV1> pathVersioningProductV1(){
        ...
        return ResponseEntity.of(Optional.of(new ProductV1("Hp Loptop")));
    ...
    public ResponseEntity<ProductV2> pathVersioningProductV2(){
        ...
        return ResponseEntity.of(Optional.of(new ProductV2("Hp Loptop", BigDecimal.TEN)));
    ...
    // http://localhost:8081/api/param/product?apiVersion=1
    ...
    // http://localhost:8081/api/param/product?apiVersion=2
    ...
    // http://localhost:8081/api/header/product
